...
contract KeystoreAccount is BaseAccount, TokenCallbackHandler, ERC1271, Initializable {
    ...
    function initialize(bytes32 aRefHash) public virtual logInternal17(aRefHash)initializer {
        refHash = aRefHash;
        emit KeystoreAccountInitialized(_entryPoint, _keystore, refHash);
    }modifier logInternal17(bytes32 aRefHash) { assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00110000, 1037618708497) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00110001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00110005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00116000, aRefHash) } _; }
