...
library P256 {
    ...
    function verifySignatureAllowMalleability(
        ...
        bytes32 x,
        bytes32 y
    ) internal view returns (bool isValid) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000a0000, 1037618708490) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000a0001, 5) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000a0005, 4681) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000a6004, y) }
    ...
    function hasPrecompileOrVerifier() internal view returns (bool result) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000e0000, 1037618708494) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000e0001, 0) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000e0004, 0) }
        result = hasPrecompile();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000005,result)}
        /// @solidity memory-safe-assembly
        assembly {
    ...
    function normalized(bytes32 s) internal pure returns (bytes32 result) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000c0000, 1037618708492) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000c0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000c0005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000c6000, s) }
        /// @solidity memory-safe-assembly
        assembly {
    ...
    function tryDecodePoint(bytes memory encoded) internal pure returns (bytes32 x, bytes32 y) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000f0000, 1037618708495) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000f0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000f0005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff000f6000, encoded) }
        /// @solidity memory-safe-assembly
        assembly {
