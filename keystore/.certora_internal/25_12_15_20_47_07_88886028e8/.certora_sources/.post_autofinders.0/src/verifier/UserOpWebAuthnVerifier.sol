...
contract UserOpWebAuthnVerifier is IVerifier, OnlyKeystore {
    ...
    {
        WebAuthn.WebAuthnAuth memory auth = WebAuthn.tryDecodeAuth(data);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010001,0)}
        ...
        (bytes32 x, bytes32 y) = abi.decode(config, (bytes32, bytes32));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010002,0)}
