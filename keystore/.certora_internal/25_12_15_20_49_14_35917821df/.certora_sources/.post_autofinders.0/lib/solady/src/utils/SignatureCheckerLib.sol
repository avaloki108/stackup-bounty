...
library SignatureCheckerLib {
    ...
    function isValidSignatureNow(address signer, bytes32 hash, uint8 v, bytes32 r, bytes32 s)
        ...
        view
        returns (bool isValid)
    {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00380000, 1037618708536) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00380001, 5) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00380005, 4681) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00386004, s) }
        if (signer == address(0)) return isValid;
        /// @solidity memory-safe-assembly
        assembly {
            let m := mload(0x40)
    ...
    ) internal view returns (bool isValid) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00390000, 1037618708537) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00390001, 4) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00390005, 602) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00396102, signature.offset) }
        /// @solidity memory-safe-assembly
        assembly {
            let m := mload(0x40)
            let f := shl(224, 0x1626ba7e)
    ...
    ) internal returns (bool isValid) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff003c0000, 1037618708540) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff003c0001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff003c0005, 73) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff003c6002, signature) }
        /// @solidity memory-safe-assembly
        assembly {
    ...
    function toEthSignedMessageHash(bytes memory s) internal pure returns (bytes32 result) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff003f0000, 1037618708543) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff003f0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff003f0005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff003f6000, s) }
        /// @solidity memory-safe-assembly
        assembly {
            let sLength := mload(s)
            let o := 0x20
