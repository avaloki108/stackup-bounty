...
library WebAuthn {
    ...
    function verify(
        ...
        bytes32 x,
        bytes32 y
    ) internal view returns (bool result) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00110000, 1037618708497) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00110001, 5) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00110005, 4681) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00116004, y) }
        bytes32 messageHash;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000006,messageHash)}
        string memory encoded = Base64.encode(challenge, true, true);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010007,0)}
    ...
    function verify(
        ...
        bytes32 x,
        bytes32 y
    ) internal view returns (bool) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00120000, 1037618708498) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00120001, 10) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00120005, 153391689) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00126009, y) }
        return verify(
            challenge,
    ...
    function tryDecodeAuthCompactCalldata(bytes calldata encodedAuth)
        ...
        pure
        returns (WebAuthnAuth memory decoded)
    {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00170000, 1037618708503) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00170001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00170005, 26) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00176100, encodedAuth.offset) }
        /// @solidity memory-safe-assembly
        assembly {
            function extractBytes(o_, l_) -> _m {
                _m := mload(0x40) // Grab the free memory pointer.
