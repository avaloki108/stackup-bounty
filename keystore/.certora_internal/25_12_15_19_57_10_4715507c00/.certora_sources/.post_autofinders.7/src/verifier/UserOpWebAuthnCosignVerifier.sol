...
contract UserOpWebAuthnCosignVerifier is IVerifier, OnlyKeystore {
    ...
    {
        bytes memory ecdsaSignature;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010001,0)}
        bytes memory webauthnData;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010002,0)}
        if (bytes1(data[0]) == SIGNATURES_ONLY_TAG) {
            (ecdsaSignature, webauthnData) = abi.decode(data[1:], (bytes, bytes));
        } else {
            PackedUserOperation memory userOp = abi.decode(data, (PackedUserOperation));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010007,0)}
            (ecdsaSignature, webauthnData) = abi.decode(userOp.signature, (bytes, bytes));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020008,0)}
        }

        (address cosigner, bytes32 x, bytes32 y) = abi.decode(config, (address, bytes32, bytes32));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010003,0)}
        WebAuthn.WebAuthnAuth memory auth = WebAuthn.tryDecodeAuth(webauthnData);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010004,0)}
        ...
        bool cosignValid = cosigner == ECDSA.recover(ECDSA.toEthSignedMessageHash(message), ecdsaSignature);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000005,cosignValid)}
        bool webauthnValid = WebAuthn.verify(abi.encode(message), true, auth, x, y);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000006,webauthnValid)}
