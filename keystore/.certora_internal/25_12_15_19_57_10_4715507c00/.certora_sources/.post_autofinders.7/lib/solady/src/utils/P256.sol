...
library P256 {
    ...
    function verifySignatureAllowMalleability(
        ...
        bytes32 x,
        bytes32 y
    ) internal view returns (bool isValid) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0d9a0000, 1037618711962) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0d9a0001, 5) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0d9a0005, 4681) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0d9a6004, y) }
    ...
    {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0d9b0000, 1037618711963) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0d9b0001, 5) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0d9b0005, 4681) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0d9b6004, y) }
        /// @solidity memory-safe-assembly
        assembly {
            let m := mload(0x40)
            mstore(m, hash)
    ...
    function hasPrecompile() internal view returns (bool result) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0d9d0000, 1037618711965) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0d9d0001, 0) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0d9d0004, 0) }
        /// @solidity memory-safe-assembly
        assembly {
            let m := mload(0x40)
    ...
    function hasPrecompileOrVerifier() internal view returns (bool result) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0d9e0000, 1037618711966) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0d9e0001, 0) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0d9e0004, 0) }
        result = hasPrecompile();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000012a,result)}
        /// @solidity memory-safe-assembly
        assembly {
    ...
    function normalized(bytes32 s) internal pure returns (bytes32 result) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0d9c0000, 1037618711964) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0d9c0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0d9c0005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0d9c6000, s) }
        /// @solidity memory-safe-assembly
        assembly {
    ...
    function tryDecodePoint(bytes memory encoded) internal pure returns (bytes32 x, bytes32 y) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0d9f0000, 1037618711967) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0d9f0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0d9f0005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0d9f6000, encoded) }
        /// @solidity memory-safe-assembly
        assembly {
    ...
    {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0da00000, 1037618711968) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0da00001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0da00005, 26) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0da06100, encoded.offset) }
        /// @solidity memory-safe-assembly
        assembly {
