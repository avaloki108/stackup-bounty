...
library WebAuthn {
    ...
    function verify(
        ...
        bytes32 x,
        bytes32 y
    ) internal view returns (bool result) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0da10000, 1037618711969) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0da10001, 5) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0da10005, 4681) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0da16004, y) }
        bytes32 messageHash;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000012b,messageHash)}
        string memory encoded = Base64.encode(challenge, true, true);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001012c,0)}
    ...
    function verify(
        ...
        bytes32 x,
        bytes32 y
    ) internal view returns (bool) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0da20000, 1037618711970) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0da20001, 10) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0da20005, 153391689) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0da26009, y) }
        return verify(
            challenge,
    ...
    function encodeAuth(WebAuthnAuth memory auth) internal pure returns (bytes memory) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0da40000, 1037618711972) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0da40001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0da40005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0da46000, auth) }
    ...
    {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0da50000, 1037618711973) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0da50001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0da50005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0da56000, encodedAuth) }
        /// @solidity memory-safe-assembly
        assembly {
    ...
    {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0da30000, 1037618711971) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0da30001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0da30005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0da36000, auth) }
        /// @solidity memory-safe-assembly
        assembly {
    ...
    function tryDecodeAuthCompact(bytes memory encodedAuth)
        ...
        pure
        returns (WebAuthnAuth memory decoded)
    {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0da60000, 1037618711974) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0da60001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0da60005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0da66000, encodedAuth) }
        /// @solidity memory-safe-assembly
        assembly {
    ...
    function tryDecodeAuthCompactCalldata(bytes calldata encodedAuth)
        ...
        pure
        returns (WebAuthnAuth memory decoded)
    {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0da70000, 1037618711975) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0da70001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0da70005, 26) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0da76100, encodedAuth.offset) }
        /// @solidity memory-safe-assembly
        assembly {
            function extractBytes(o_, l_) -> _m {
                _m := mload(0x40) // Grab the free memory pointer.
