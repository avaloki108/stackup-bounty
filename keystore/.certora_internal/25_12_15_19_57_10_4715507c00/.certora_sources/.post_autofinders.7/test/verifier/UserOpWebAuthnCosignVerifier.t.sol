...
contract UserOpWebAuthnCosignVerifierTest is Test {
    ...
    function setUp() public {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0c060000, 1037618711558) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0c060001, 0) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0c060004, 0) }
        verifier = new UserOpWebAuthnCosignVerifier(address(this));
        _etchP256Verifier();
    }

    function testFuzz_validateData(bool withUserOp, uint256 index) public {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0bff0000, 1037618711551) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0bff0001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0bff0005, 9) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0bff6001, index) }
        (address cosigner, uint256 cosignerPK) = makeAddrAndKey("cosigner");assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010009,0)}
        P256Key memory signer = _getSigner(index);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001000a,0)}
        bytes32 message = keccak256("Signed by signer");assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000b,message)}
        bytes memory signature = _webAuthnCosign(cosignerPK, uint256(signer.pk), message);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001000c,0)}

        bytes memory data = signature;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001000d,0)}
        if (withUserOp) {
            PackedUserOperation memory userOp;
            userOp.signature = signature;
            data = abi.encode(userOp);
        } else {
            data = abi.encodePacked(verifier.SIGNATURES_ONLY_TAG(), data);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020043,0)}
        }

        uint256 validationData = verifier.validateData(message, data, abi.encode(cosigner, signer.x, signer.y));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000e,validationData)}
        assertEq(validationData, SIG_VALIDATION_SUCCESS);
    }

    function testFuzz_validateDataValidationFailedWebAuthn(bool withUserOp, uint256 index, bytes32 x, bytes32 y)
        public
    {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0c0a0000, 1037618711562) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0c0a0001, 4) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0c0a0005, 585) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0c0a6003, y) }
        (address cosigner, uint256 cosignerPK) = makeAddrAndKey("cosigner");assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001000f,0)}
        P256Key memory signer = _getSigner(index);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010010,0)}
        bytes32 message = keccak256("Signed by signer");assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000011,message)}
        bytes memory signature = _webAuthnCosign(cosignerPK, uint256(signer.pk), message);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010012,0)}

        bytes memory data = signature;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010013,0)}
        if (withUserOp) {
            PackedUserOperation memory userOp;
            userOp.signature = signature;
            data = abi.encode(userOp);
        } else {
            data = abi.encodePacked(verifier.SIGNATURES_ONLY_TAG(), data);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020044,0)}
        }

        uint256 validationData = verifier.validateData(message, data, abi.encode(cosigner, x, y));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000014,validationData)}
        assertEq(validationData, SIG_VALIDATION_FAILED);
    }

    function testFuzz_validateDataValidationFailedCosign(bool withUserOp, uint256 index, address cosigner) public {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0c090000, 1037618711561) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0c090001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0c090005, 73) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0c096002, cosigner) }
        (, uint256 cosignerPK) = makeAddrAndKey("cosigner");assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010015,0)}
        P256Key memory signer = _getSigner(index);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010016,0)}
        bytes32 message = keccak256("Signed by signer");assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000017,message)}
        bytes memory signature = _webAuthnCosign(cosignerPK, uint256(signer.pk), message);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010018,0)}

        bytes memory data = signature;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010019,0)}
        if (withUserOp) {
            PackedUserOperation memory userOp;
            userOp.signature = signature;
            data = abi.encode(userOp);
        } else {
            data = abi.encodePacked(verifier.SIGNATURES_ONLY_TAG(), data);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020045,0)}
        }

        uint256 validationData = verifier.validateData(message, data, abi.encode(cosigner, signer.x, signer.y));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000001a,validationData)}
        assertEq(validationData, SIG_VALIDATION_FAILED);
    }

    function testFuzz_validateDataInvalidCaller(address keystore) public {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0c0c0000, 1037618711564) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0c0c0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0c0c0005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0c0c6000, keystore) }
    ...
    function testFuzz_validateDataInvalidData(bytes calldata data) public {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0c0e0000, 1037618711566) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0c0e0001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0c0e0005, 26) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0c0e6100, data.offset) }
        vm.expectRevert();
    ...
    {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0bfb0000, 1037618711547) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0bfb0001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0bfb0005, 73) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0bfb6002, message) }
        (uint8 cosignerV, bytes32 cosignerR, bytes32 cosignerS) =
            vm.sign(cosignerPrivateKey, ECDSA.toEthSignedMessageHash(message));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001001b,0)}

        string memory clientDataJSON =
            clientDataJSONPre.concat(Base64.encode(abi.encode(message), true, true)).concat(clientDataJSONPost);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001001c,0)}
        bytes32 clientDataJSONHash = sha256(bytes(clientDataJSON));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000001d,clientDataJSONHash)}
        bytes32 messageHash = sha256(abi.encodePacked(authenticatorData, clientDataJSONHash));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000001e,messageHash)}
        (bytes32 r, bytes32 s) = vm.signP256(privateKey, messageHash);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001001f,0)}
        ...
        signature = abi.encode(abi.encodePacked(cosignerR, cosignerS, cosignerV), WebAuthn.encodeAuth(auth));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020022,0)}
    }

    function _etchP256Verifier() internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0bfc0000, 1037618711548) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0bfc0001, 0) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0bfc0004, 0) }
    ...
    function _getSigner(uint256 index) internal pure returns (P256Key memory) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0bfd0000, 1037618711549) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0bfd0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0bfd0005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0bfd6000, index) }
        P256Key[] memory signers = new P256Key[](32);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010021,0)}
        signers[0] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020023,0)}
        signers[1] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020024,0)}
        signers[2] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020025,0)}
        signers[3] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020026,0)}
        signers[4] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0002002a,0)}
        signers[8] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0002002b,0)}
        signers[9] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0002002c,0)}
        signers[10] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0002002d,0)}
        signers[11] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0002002f,0)}
        signers[13] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020030,0)}
        signers[14] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020031,0)}
        signers[15] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020032,0)}
        signers[16] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020033,0)}
        signers[17] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020034,0)}
        signers[18] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020039,0)}
        signers[23] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0002003a,0)}
        signers[24] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0002003b,0)}
        signers[25] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0002003c,0)}
        signers[26] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0002003e,0)}
        signers[28] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0002003f,0)}
        signers[29] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020040,0)}
        signers[30] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020041,0)}
        signers[31] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020042,0)}
