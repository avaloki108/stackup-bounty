...
contract UserOpWebAuthnVerifierTest is Test {
    ...
    function setUp() public {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0db90000, 1037618711993) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0db90001, 0) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0db90004, 0) }
        verifier = new UserOpWebAuthnVerifier(address(this));
        _etchP256Verifier();
    }

    function testFuzz_validateData(bool withUserOp, uint256 index) public view {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0db20000, 1037618711986) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0db20001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0db20005, 9) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0db26001, index) }
        P256Key memory signer = _getSigner(index);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010003,0)}
        bytes32 message = keccak256("Signed by signer");assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000004,message)}
        bytes memory signature = _webAuthnSign(uint256(signer.pk), message);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010005,0)}

        bytes memory data = signature;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010006,0)}
        if (withUserOp) {
        ...
        uint256 validationData = verifier.validateData(message, data, abi.encode(signer.x, signer.y));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000007,validationData)}
        assertEq(validationData, SIG_VALIDATION_SUCCESS);
    }

    function testFuzz_validateDataValidationFailed(bool withUserOp, uint256 index, bytes32 x, bytes32 y) public view {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0dbe0000, 1037618711998) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0dbe0001, 4) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0dbe0005, 585) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0dbe6003, y) }
        P256Key memory signer = _getSigner(index);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010008,0)}
        bytes32 message = keccak256("Signed by signer");assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000009,message)}
        bytes memory signature = _webAuthnSign(uint256(signer.pk), message);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001000a,0)}

        bytes memory data = signature;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001000b,0)}
        if (withUserOp) {
            PackedUserOperation memory userOp;
            userOp.signature = signature;
            data = abi.encode(userOp);
        ...
        uint256 validationData = verifier.validateData(message, data, abi.encode(x, y));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000c,validationData)}
        assertEq(validationData, SIG_VALIDATION_FAILED);
    }

    function testFuzz_validateDataInvalidCaller(address keystore) public {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0dbd0000, 1037618711997) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0dbd0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0dbd0005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0dbd6000, keystore) }
    ...
    function testFuzz_validateDataInvalidData(bytes calldata data) public {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0dc00000, 1037618712000) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0dc00001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0dc00005, 26) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0dc06100, data.offset) }
        vm.expectRevert();
    ...
    function _webAuthnSign(uint256 privateKey, bytes32 message) internal pure returns (bytes memory signature) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0dae0000, 1037618711982) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0dae0001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0dae0005, 9) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0dae6001, message) }
        string memory clientDataJSON =
            clientDataJSONPre.concat(Base64.encode(abi.encode(message), true, true)).concat(clientDataJSONPost);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001000d,0)}
        bytes32 clientDataJSONHash = sha256(bytes(clientDataJSON));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000e,clientDataJSONHash)}
        bytes32 messageHash = sha256(abi.encodePacked(authenticatorData, clientDataJSONHash));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000f,messageHash)}
        (bytes32 r, bytes32 s) = vm.signP256(privateKey, messageHash);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010010,0)}
        ...
        signature = WebAuthn.encodeAuth(auth);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020013,0)}
    }

    function _etchP256Verifier() internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0daf0000, 1037618711983) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0daf0001, 0) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0daf0004, 0) }
    ...
    function _getSigner(uint256 index) internal pure returns (P256Key memory) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0db00000, 1037618711984) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0db00001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0db00005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0db06000, index) }
        P256Key[] memory signers = new P256Key[](32);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010012,0)}
        signers[0] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020014,0)}
        signers[1] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020015,0)}
        signers[2] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020016,0)}
        signers[3] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020017,0)}
        signers[4] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020018,0)}
        signers[5] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020019,0)}
        signers[6] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0002001a,0)}
        signers[7] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0002001b,0)}
        signers[8] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0002001c,0)}
        signers[9] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0002001d,0)}
        signers[10] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0002001e,0)}
        signers[11] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0002001f,0)}
        signers[12] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020020,0)}
        signers[13] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020021,0)}
        signers[14] = P256Key({
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020022,0)}
        signers[15] = P256Key({
