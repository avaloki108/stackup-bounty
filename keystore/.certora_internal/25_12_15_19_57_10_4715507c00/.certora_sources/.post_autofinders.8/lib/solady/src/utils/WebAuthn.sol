...
library WebAuthn {
    ...
    function verify(
        ...
        bytes32 x,
        bytes32 y
    ) internal view returns (bool result) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f440000, 1037618712388) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f440001, 5) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f440005, 4681) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f446004, y) }
        bytes32 messageHash;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000119,messageHash)}
        string memory encoded = Base64.encode(challenge, true, true);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001011a,0)}
    ...
    function verify(
        ...
        bytes32 x,
        bytes32 y
    ) internal view returns (bool) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f450000, 1037618712389) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f450001, 10) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f450005, 153391689) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f456009, y) }
        return verify(
            challenge,
    ...
    function encodeAuth(WebAuthnAuth memory auth) internal pure returns (bytes memory) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f470000, 1037618712391) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f470001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f470005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f476000, auth) }
    ...
    {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f480000, 1037618712392) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f480001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f480005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f486000, encodedAuth) }
        /// @solidity memory-safe-assembly
        assembly {
    ...
    {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f460000, 1037618712390) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f460001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f460005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f466000, auth) }
        /// @solidity memory-safe-assembly
        assembly {
    ...
    function tryDecodeAuthCompact(bytes memory encodedAuth)
        ...
        pure
        returns (WebAuthnAuth memory decoded)
    {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f490000, 1037618712393) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f490001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f490005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f496000, encodedAuth) }
        /// @solidity memory-safe-assembly
        assembly {
    ...
    function tryDecodeAuthCompactCalldata(bytes calldata encodedAuth)
        ...
        pure
        returns (WebAuthnAuth memory decoded)
    {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f4a0000, 1037618712394) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f4a0001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f4a0005, 26) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f4a6100, encodedAuth.offset) }
        /// @solidity memory-safe-assembly
        assembly {
            function extractBytes(o_, l_) -> _m {
                _m := mload(0x40) // Grab the free memory pointer.
