...
library P256 {
    ...
    function verifySignatureAllowMalleability(
        ...
        bytes32 x,
        bytes32 y
    ) internal view returns (bool isValid) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f3d0000, 1037618712381) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f3d0001, 5) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f3d0005, 4681) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f3d6004, y) }
    ...
    {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f3e0000, 1037618712382) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f3e0001, 5) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f3e0005, 4681) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f3e6004, y) }
        /// @solidity memory-safe-assembly
        assembly {
            let m := mload(0x40)
            mstore(m, hash)
    ...
    function hasPrecompile() internal view returns (bool result) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f400000, 1037618712384) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f400001, 0) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f400004, 0) }
        /// @solidity memory-safe-assembly
        assembly {
            let m := mload(0x40)
    ...
    function hasPrecompileOrVerifier() internal view returns (bool result) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f410000, 1037618712385) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f410001, 0) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f410004, 0) }
        result = hasPrecompile();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000118,result)}
        /// @solidity memory-safe-assembly
        assembly {
    ...
    function normalized(bytes32 s) internal pure returns (bytes32 result) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f3f0000, 1037618712383) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f3f0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f3f0005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f3f6000, s) }
        /// @solidity memory-safe-assembly
        assembly {
    ...
    function tryDecodePoint(bytes memory encoded) internal pure returns (bytes32 x, bytes32 y) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f420000, 1037618712386) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f420001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f420005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f426000, encoded) }
        /// @solidity memory-safe-assembly
        assembly {
    ...
    {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f430000, 1037618712387) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f430001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f430005, 26) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0f436100, encoded.offset) }
        /// @solidity memory-safe-assembly
        assembly {
