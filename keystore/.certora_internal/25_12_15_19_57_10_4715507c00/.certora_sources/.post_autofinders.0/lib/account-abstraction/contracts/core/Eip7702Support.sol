...
library Eip7702Support {
     ...
     */
    function _getEip7702InitCodeHashOverride(PackedUserOperation calldata userOp) internal view returns (bytes32) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00360000, 1037618708534) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00360001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00360005, 4) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00366200, userOp) }
        bytes calldata initCode = userOp.initCode;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010036,0)}
        if (!_isEip7702InitCode(initCode)) {
            return 0;
        }
        address delegate = _getEip7702Delegate(userOp.sender);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000037,delegate)}
     ...
     */
    function _isEip7702InitCode(bytes calldata initCode) internal pure returns (bool) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00370000, 1037618708535) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00370001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00370005, 26) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00376100, initCode.offset) }

        if (initCode.length < 2) {
            return false;
        }
        bytes20 initCodeStart;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000038,initCodeStart)}
     ...
     */
    function _getEip7702Delegate(address sender) internal view returns (address) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00380000, 1037618708536) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00380001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00380005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00386000, sender) }

        bytes32 senderCode;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000039,senderCode)}
