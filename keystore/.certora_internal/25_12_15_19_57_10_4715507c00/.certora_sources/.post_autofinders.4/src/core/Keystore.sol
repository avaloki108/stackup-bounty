...
contract Keystore is IKeystore, ReentrancyGuardTransient {
    ...
    function _unpackNonceKey(uint256 nonce) internal pure returns (uint192 nonceKey, uint64 nonceSeq) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff078b0000, 1037618710411) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff078b0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff078b0005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff078b6000, nonce) }
    ...
    {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff078c0000, 1037618710412) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff078c0001, 4) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff078c0005, 585) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff078c6003, seq) }
    ...
    function _incrementNonce(bytes32 refHash, address account, uint192 key, uint64 currSeq) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff078e0000, 1037618710414) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff078e0001, 4) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff078e0005, 585) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff078e6003, currSeq) }
        _nonceSequence[refHash][key][account] = currSeq + 1;
    }

    function _getCurrentRootHash(bytes32 refHash, address account) internal view returns (bytes32) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff078f0000, 1037618710415) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff078f0001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff078f0005, 9) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff078f6001, account) }
    ...
    function _unpackNode(bytes memory node) internal pure returns (address verifier, bytes memory config) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff078d0000, 1037618710413) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff078d0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff078d0005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff078d6000, node) }
    ...
    {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff07900000, 1037618710416) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff07900001, 6) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff07900005, 38554) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff07906104, aNode.offset) }
        if (aProof.length == 0) {
    ...
    {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff07910000, 1037618710417) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff07910001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff07910005, 33) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff07916001, nodeHash) }
    ...
    function _isSigValidationFailed(bytes32 message, bytes memory node, bytes memory data)
        ...
        view
        returns (bool)
    {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff07920000, 1037618710418) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff07920001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff07920005, 73) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff07926002, data) }
    ...
    ) internal pure returns (bool) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff07930000, 1037618710419) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff07930001, 6) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff07930005, 38554) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff07936104, nextNode.offset) }
