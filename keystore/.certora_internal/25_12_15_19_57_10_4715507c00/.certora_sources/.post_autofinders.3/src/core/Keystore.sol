...
contract Keystore is IKeystore, ReentrancyGuardTransient {
    ...
    function _unpackNonceKey(uint256 nonce) internal pure returns (uint192 nonceKey, uint64 nonceSeq) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff060f0000, 1037618710031) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff060f0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff060f0005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff060f6000, nonce) }
    ...
    {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff06100000, 1037618710032) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff06100001, 4) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff06100005, 585) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff06106003, seq) }
    ...
    function _incrementNonce(bytes32 refHash, address account, uint192 key, uint64 currSeq) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff06120000, 1037618710034) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff06120001, 4) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff06120005, 585) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff06126003, currSeq) }
        _nonceSequence[refHash][key][account] = currSeq + 1;
    }

    function _getCurrentRootHash(bytes32 refHash, address account) internal view returns (bytes32) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff06130000, 1037618710035) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff06130001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff06130005, 9) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff06136001, account) }
    ...
    function _unpackNode(bytes memory node) internal pure returns (address verifier, bytes memory config) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff06110000, 1037618710033) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff06110001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff06110005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff06116000, node) }
    ...
    {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff06140000, 1037618710036) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff06140001, 6) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff06140005, 38554) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff06146104, aNode.offset) }
        if (aProof.length == 0) {
    ...
    {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff06150000, 1037618710037) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff06150001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff06150005, 33) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff06156001, nodeHash) }
    ...
    function _isSigValidationFailed(bytes32 message, bytes memory node, bytes memory data)
        ...
        view
        returns (bool)
    {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff06160000, 1037618710038) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff06160001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff06160005, 73) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff06166002, data) }
    ...
    ) internal pure returns (bool) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff06170000, 1037618710039) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff06170001, 6) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff06170005, 38554) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff06176104, nextNode.offset) }
