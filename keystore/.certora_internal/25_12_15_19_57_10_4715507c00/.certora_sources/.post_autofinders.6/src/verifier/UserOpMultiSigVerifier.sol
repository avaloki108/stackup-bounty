...
contract UserOpMultiSigVerifier is IVerifier, OnlyKeystore {
    ...
    {
        (uint8 threshold, address[] memory owners) = abi.decode(config, (uint8, address[]));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010001,0)}
        ...
        SignerData[] memory signatures;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010002,0)}
        if (bytes1(data[0]) == SIGNATURES_ONLY_TAG) {
            (signatures) = abi.decode(data[1:], (SignerData[]));
        } else {
            PackedUserOperation memory userOp = abi.decode(data, (PackedUserOperation));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010008,0)}
            signatures = abi.decode(userOp.signature, (SignerData[]));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0002000a,0)}
        }
        uint256 length = signatures.length;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000003,length)}
        require(length <= type(uint8).max, MaxSignaturesExceeded());

        SignatureCheck memory sc;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010004,0)}
        sc.message = ECDSA.toEthSignedMessageHash(message);bytes32 certora_local7 = sc.message;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000007,certora_local7)}
        bool[] memory seen = new bool[](owners.length);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010005,0)}
        for (uint256 i = 0; i < length; i++) {
            SignerData memory sd = signatures[i];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010009,0)}
            ...
            seen[sd.index] = true;bool certora_local11 = seen[sd.index];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000b,certora_local11)}
        }
     ...
     */
    function _requireSortedAndUnique(address[] memory owners) internal pure {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0a4e0000, 1037618711118) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0a4e0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0a4e0005, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff0a4e6000, owners) }
        uint256 length = owners.length;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000006,length)}
