...
methods {
    ...
    // External token calls - use NONDET as we don't link token contracts
    function _.balanceOf(address) external => NONDET;
    function _.transfer(address, uint256) external returns (bool) => NONDET;
}
 ...
 * Note: This is a tautology test to verify the prover is working
 */
rule receiverConsistent() {
    address r1 = receiver();
    address r2 = receiver();
    assert r1 == r2, "Receiver should be consistent";
}
